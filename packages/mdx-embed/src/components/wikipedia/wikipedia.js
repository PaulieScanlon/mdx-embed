...
export const Wikipedia = ({ wikipediaLink, height = 600 }) => {
    ...
    return (React.createElement(GeneralObserver, null, !wikiResponse.isLoading && (React.createElement("iframe", { className: "wikipedia-mdx-embed", title: wikipediaLink, frameBorder: "0", style: {
            width: '100%',
            minHeight: height,
