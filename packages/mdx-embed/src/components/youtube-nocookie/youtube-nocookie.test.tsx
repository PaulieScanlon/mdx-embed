...
import { YouTubeNoCookie } from '.';

describe('<YouTubeNoCookie />', () => {
  beforeEach(() => {
    (window as any).addIntersectionObserver();
  });

  test('it renders the component when provided a youTubeId', () => {
    render(<YouTubeNoCookie youTubeId="mM5_T-F1Yn4" />);
  ...
  test.only('it renders the component skipTo defined', () => {
    render(<YouTubeNoCookie youTubeId="PS2784YfPpw" skipTo={{ h: 0, m: 38, s: 44 }} />);
  ...
  test('it renders the component autoplay defined', () => {
    render(<YouTubeNoCookie youTubeId="PS2784YfPpw" autoPlay={true} />);
